...
HD_PWD='C:/Users/Jonemaster/Desktop/montgomery/Vivado/monygomery/monygomery.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log montgomery_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source montgomery_top.tcl -notrace
