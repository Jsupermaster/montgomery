...
HD_PWD='C:/Users/Jonemaster/Desktop/montgomery/Vivado/monygomery/monygomery.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log montgomery_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source montgomery_top.tcl
